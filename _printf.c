 ...
 * updates the output buffer with the formatted output.
 * It handles different specifier cases ('c', 's', 'd', 'i').
 * After processing the specifier, the function increments
 * the pointer to the format string,updates the printed character count,
 ...
 * @args: Variable arguments corresponding to the format specifier.
 * @printed_chars: Pointer to the count of printed characters.
 * Description: This function processes a valid format specifier and
 * updates the output buffer with the formatted output.
 * It handles different specifier cases ('c', 's', 'd', 'i').
 * After processing the specifier,
 * the function increments the pointer to the format string,
